...
RUN case "${TARGETARCH}" in \
        "amd64") \
            curl --location https://openssl-library.org/source/old/1.1.1/openssl-1.1.1k.tar.gz | tar -xzf - \
            && cd openssl-1.1.1k \
            ...
            ;; \
        "arm64") \
            curl --location https://openssl-library.org/source/old/1.1.1/openssl-1.1.1w.tar.gz | tar -xzf - \
            && cd openssl-1.1.1w \
